...
Client API 
   ...
   - :ref:`SerializingConsumer <serde_producer>`
...
Supporting classes
    ...
    - :ref:`SerializationContext <serde_ctx>`
    - :ref:`Schema <schemaregistry_schema>`
    - :ref:`RegisteredSchema <schemaregistry_registered_schema>`
    - :ref:`SchemaRegistryError <schemaregistry_error>`
    - :ref:`KafkaError <pythonclient_kafkaerror>`
    - :ref:`KafkaException <pythonclient_kafkaexception>`
    - :ref:`ConsumeError <serde_consumer_error>`
